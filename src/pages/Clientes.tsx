                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 overflow-hidden bg-slate-100 text-slate-600">
                              {client.logo_base64 ? <img src={client.logo_base64} alt="" className="h-full w-full object-contain p-1" /> : <Building2 className="w-5 h-5" />}
                            </div>
          ...
          <div className="p-5 md:p-7 border-b border-slate-100">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-5">
              <div className="flex items-start gap-4 min-w-0">
                <div className="w-14 h-14 flex items-center justify-center overflow-hidden bg-slate-900 text-white rounded-2xl shrink-0">
                  {selectedClient.logo_base64 ? <img src={selectedClient.logo_base64} alt={`Logo de ${selectedClient.nombre}`} className="h-full w-full bg-white object-contain p-1.5" /> : <Building2 className="w-6 h-6" />}
                </div>
                <div className="min-w-0">
