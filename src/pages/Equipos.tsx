          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
            {filteredEquipos.map(eq => (
              ...
              >
                 ...
                 <button 
                   onClick={(e) => { e.stopPropagation(); setSelectedEqLabel({ uuid_sync: eq.uuid_sync, tag: eq.tag, desc: eq.nombre, cliente_id: eq.cliente_id }); }}
    ...
    >
       ...
       <div className="flex justify-between items-start mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              onClick={(e) => { e.stopPropagation(); onShowLabel({ uuid_sync: equipo.uuid_sync, tag: equipo.tag, desc: equipo.nombre, cliente_id: equipo.cliente_id }); }}
