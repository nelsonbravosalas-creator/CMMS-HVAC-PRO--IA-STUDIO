...
export const API_ENDPOINTS = {
  ...
  // Técnicos: se sirven desde users filtrado por perfil
  technicians:      '/api/users?perfil=tecnico',
  technicianById:   (id: string) => `/api/users/${id}`,

  // Dashboard: pendiente de implementación — comentado hasta crear los handlers
